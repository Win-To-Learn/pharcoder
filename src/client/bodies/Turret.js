...
Turret.add = function (game, options) {
    var s = new Turret(game, options);
    game.add.existing(s);
    return s;
};
...
Turret.prototype.mapFactor = 3;

Turret.prototype.updateTextures = function () {
...
Turret.prototype.update = function () {
    ...
    //}
    // Player ship only
    if (this.game.playerTurret === this) {
