...
var genera = [
    {name: 'Warrior', props: {thrustForce: 35, targetType: 'Ship', lineColor: '#ffa500'}},
    {name: 'EcoTerrorist', props: {thrustForce: 25, targetType: 'Tree', lineColor: '#ffcc99', patience: 10000}},
    {name: 'BlockBuster', props: {thrustForce: 5, targetType: 'StationBlock', lineColor: '#ffff00', patience: 12000}}
];
